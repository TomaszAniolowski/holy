...
return (
    ...
    test:assert-equal-json($expected-verse-with-letter-part-4, $actual-verse-with-letter-part-4, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-4),
    test:assert-equal-json($expected-verse-with-letter-part-5, $actual-verse-with-letter-part-5, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-5),
    test:assert-equal-json($expected-verse-with-letter-part-range-correct-1, $actual-verse-with-letter-part-range-correct-1, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-RANGE-CORRECT-1),
    test:assert-equal-json($expected-verse-with-letter-part-range-correct-2, $actual-verse-with-letter-part-range-correct-2, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-RANGE-CORRECT-2),
    test:assert-equal-json($expected-verse-with-letter-part-range-correct-3, $actual-verse-with-letter-part-range-correct-3, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-RANGE-CORRECT-3),
    test:assert-equal-json($expected-verse-with-letter-part-range-incorrect-1, $actual-verse-with-letter-part-range-incorrect-1, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-RANGE-INCORRECT-1),
    test:assert-equal-json($expected-verse-with-letter-part-range-incorrect-2, $actual-verse-with-letter-part-range-incorrect-2, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-RANGE-INCORRECT-2),
    test:assert-equal-json($expected-verse-with-letter-part-range-incorrect-3, $actual-verse-with-letter-part-range-incorrect-3, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-RANGE-INCORRECT-3),
    test:assert-equal-json($expected-verse-with-letter-part-range-incorrect-4, $actual-verse-with-letter-part-range-incorrect-4, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-RANGE-INCORRECT-4),
    test:assert-equal-json($expected-verse-with-letter-part-sequence, $actual-verse-with-letter-part-sequence, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-SEQUENCE),
    test:assert-equal-json($expected-verse-with-letter-part-next, $actual-verse-with-letter-part-next, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-NEXT),
    test:assert-equal-json($expected-verse-with-letter-part-next-next, $actual-verse-with-letter-part-next-next, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-NEXT-NEXT),
    test:assert-equal-json($expected-verse-with-letter-part-sequence-overlapping-1, $actual-verse-with-letter-part-sequence-overlapping-1, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-SEQUENCE-OVERLAPPING-1),
    test:assert-equal-json($expected-verse-with-letter-part-sequence-overlapping-2, $actual-verse-with-letter-part-sequence-overlapping-2, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-SEQUENCE-OVERLAPPING-2),
    test:assert-equal-json($expected-verse-with-letter-part-sequence-overlapping-3, $actual-verse-with-letter-part-sequence-overlapping-3, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-SEQUENCE-OVERLAPPING-3),
    test:assert-equal-json($expected-verse-with-letter-part-range-sequence-overlapping, $actual-verse-with-letter-part-range-sequence-overlapping, 'Incorrect interpretation for siglum: ' || $SIGLUM-VERSE-WITH-LETTER-PART-RANGE-SEQUENCE-OVERLAPPING),
    test:assert-equal-json($expected-exceptional-verses-1-correct, $actual-exceptional-verses-1-correct, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-1-CORRECT),
    test:assert-equal-json($expected-exceptional-verses-1-incorrect, $actual-exceptional-verses-1-incorrect, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-1-INCORRECT),
    test:assert-equal-json($expected-exceptional-verses-2-correct, $actual-exceptional-verses-2-correct, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-2-CORRECT),
    test:assert-equal-json($expected-exceptional-verses-2-incorrect, $actual-exceptional-verses-2-incorrect, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-2-INCORRECT),
    test:assert-equal-json($expected-exceptional-verses-3-correct-1, $actual-exceptional-verses-3-correct-1, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-CORRECT-1),
    test:assert-equal-json($expected-exceptional-verses-3-correct-2, $actual-exceptional-verses-3-correct-2, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-CORRECT-2),
    test:assert-equal-json($expected-exceptional-verses-3-correct-3, $actual-exceptional-verses-3-correct-3, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-CORRECT-3),
    test:assert-equal-json($expected-exceptional-verses-3-correct-4, $actual-exceptional-verses-3-correct-4, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-CORRECT-4),
    test:assert-equal-json($expected-exceptional-verses-3-correct-5, $actual-exceptional-verses-3-correct-5, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-CORRECT-5),
    test:assert-equal-json($expected-exceptional-verses-3-correct-6, $actual-exceptional-verses-3-correct-6, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-CORRECT-6),
    test:assert-equal-json($expected-exceptional-verses-3-incorrect-1, $actual-exceptional-verses-3-incorrect-1, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-INCORRECT-1),
    test:assert-equal-json($expected-exceptional-verses-3-incorrect-2, $actual-exceptional-verses-3-incorrect-2, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-INCORRECT-2),
    test:assert-equal-json($expected-exceptional-verses-3-incorrect-3, $actual-exceptional-verses-3-incorrect-3, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-INCORRECT-3),
    test:assert-equal-json($expected-exceptional-verses-3-incorrect-4, $actual-exceptional-verses-3-incorrect-4, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-INCORRECT-4),
    test:assert-equal-json($expected-exceptional-verses-3-incorrect-5, $actual-exceptional-verses-3-incorrect-5, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-INCORRECT-5),
    test:assert-equal-json($expected-exceptional-verses-3-incorrect-6, $actual-exceptional-verses-3-incorrect-6, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-3-INCORRECT-6),
    test:assert-equal-json($expected-exceptional-verses-4-correct-1, $actual-exceptional-verses-4-correct-1, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-4-CORRECT-1),
    test:assert-equal-json($expected-exceptional-verses-4-correct-2, $actual-exceptional-verses-4-correct-2, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-4-CORRECT-2),
    test:assert-equal-json($expected-exceptional-verses-4-correct-3, $actual-exceptional-verses-4-correct-3, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-4-CORRECT-3),
    test:assert-equal-json($expected-exceptional-verses-4-incorrect-1, $actual-exceptional-verses-4-incorrect-1, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-4-INCORRECT-1),
    test:assert-equal-json($expected-exceptional-verses-4-incorrect-2, $actual-exceptional-verses-4-incorrect-2, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-4-INCORRECT-2),
    test:assert-equal-json($expected-exceptional-verses-4-incorrect-3, $actual-exceptional-verses-4-incorrect-3, 'Incorrect interpretation for siglum: ' || $SIGLUM-EXCEPTIONAL-VERSES-4-INCORRECT-3),
