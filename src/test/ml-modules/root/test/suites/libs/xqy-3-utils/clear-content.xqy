...
let $actual-sentence-1 := xqy3:clear-content($SENTENCE-1)
let $actual-sentence-2 := xqy3:clear-content($SENTENCE-2)
let $actual-sentence-3 := xqy3:clear-content($SENTENCE-3)
let $actual-sentence-4 := xqy3:clear-content($SENTENCE-4)
let $actual-sentence-5 := xqy3:clear-content($SENTENCE-5)
let $actual-sentence-6 := xqy3:clear-content($SENTENCE-6)
